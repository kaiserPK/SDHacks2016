...
.controller('ProjectChatCtrl', function($scope, $firebaseArray, $ionicPopup, $ionicScrollDelegate, $state, $timeout, userRef, userService) {
  var fbID = userService.getFacebookID();
  var uid = firebase.auth().currentUser.uid;
  var bulbID = userService.getBulbID();
  var msgRef = firebase.database().ref('/users/' + uid + '/projects/' + bulbID).child("messages");
